...
unsigned char SELECT_VARIABLE_VALS[] =
	"SELECT " VARIABLE_VAL " FROM " VARIABLES_TABLE " WHERE " VARIABLE_KEY
	" = :" VARIABLE_KEY " AND " RULE_ID " = :" RULE_ID ";";
...
const stmt_t SQL_STMTS[] = {
	...
	{ SELECT_VARIABLE_VALS, sizeof(SELECT_VARIABLE_VALS) },
	// Join statements
